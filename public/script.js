    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b4519e55-eb37-423a-b77e-cee2e50e432e',
                    name: data.name || '',
                    email: data.email || '',
...
// Optional: Add smooth scroll behavior for contact link
document.addEventListener('DOMContentLoaded', function() {
  const contactLinks = document.querySelectorAll('.btn-primary-cta[href^="#"]');
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b4519e55-eb37-423a-b77e-cee2e50e432e';
